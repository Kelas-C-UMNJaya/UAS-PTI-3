...
const [news, setNews, newsClock, data] = useState([])
    newsClock = setInterval(); {
        /*setNews([url='https://newsapi.org/v2/top-headlines?country=id&apiKey=32d4ac78c0a3402a8e580a387a5af5d8']);*/
        // const url ='https://newsapi.org/v2/top-headlines?country=id&apiKey=32d4ac78c0a3402a8e580a387a5af5d8';
    }
